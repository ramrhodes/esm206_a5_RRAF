---
title: "Pacific Giant Salamanders and Land Use in Mack Creek, OR" 
...
Researchers from the Andrews Forest LTER site have collected data from 1993 - 2017 on the abundance, length, weight and habitat dimensions of coastal giant salamanders (*Dicamptodon tenebrosus*) at two sites in the H.J. Andrews Experimental Forest; one of the sites was a section that was clearcut in 1963 and the other site was a 500 year old coniferous forest located further upstream. Researchers collected data annually at the same 150 meter reaches of stream using 2-pass electrofishing. 

![**Map of the H.J. Andrews Experimental Forest and Mack Creek.** *Photo: Dana Warren.*](map.png)

The effects of section type (clear cut or old growth) on the abundance of giant salamanders in different channel classifications was tested using a Chi-square test. The weights of giant salamanders found in the two forest sections were compared using two-sided, two sample t-tests with a 95% confidence interval and Cohen's d. Salamander weights by channel classification were analyzed using a one-way ANOVA test and post-hoc Tukey's HSD. All analyses and figures were prepared using R software version 3.6.1. 
...
Based on the observations recorded in 2017, the proportions of Pacific giant salamanders found in different channel classifications (cascade, pool, or side-channel) were calculated within both the clear cut and old growth sections of Mack Creek (Table 1).  Notably, the proportions of salamanders found in the different channel classifications were similar across both forest condtions. In both clear cut and old growth sections, salamander abundance was highest in cascades, lowest in pools, and were almost equal in side-channels, comprising 24% and 23% respectively. 
...
For both forest condtions, abundance (counts) and proportions of salamanders found in each channel classification were compared (Table 1). Salamanders in the clear cut section seemed to prefer cascades (67%, n = 247) and were less common in pools (8%, n = 31); salamanders in the old growth section favored pools more (14%, n = 45), but still overall preferred cascades (63%, n = 201). While the abundnace of salamanders in the different channel classifications was slightly different between the two sections, the proportions were fairly similar across both forest conditions. A Pearson's Chi-square test was used to determine that forest condition does not have an effect on where salamanders are located within the channel (*p* = `r round(s_chi_counts$p.value, 3)`). There is no clear association between forest section type and salamander location within the channel. 
...
ggplot()+
  ...
  labs(x = "Channel classification", 
        y = "Weight (g)")+
  ggtitle("WEIGHT OF PACIFIC GIANT SALAMANDERS BY CHANNEL CLASSIFICATION (2017)",
          subtitle = "Pacific giant salamander weights between cascades, pools and side-channels") +
  theme_minimal()+
...
- Salamander abundance in different channel classifications (cascades, pools, and side-channels) in 2017 was not associated with or affected by forest condition (clear cut or old growth)
